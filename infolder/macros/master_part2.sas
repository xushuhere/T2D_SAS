...
,MAX(DPP4_LINA_SGLT2_EMPA_FLAG) AS DPP4_LINA_SGLT2_EMPA_FLAG
...
,MAX(GLIM_TZD_PIOG_FLAG) AS GLIM_TZD_PIOG_FLAG
,MAX(GLIM_TZD_ROSI_FLAG) AS GLIM_TZD_ROSI_FLAG
...
,MAX(METFORMIN_MEGL_REPA_FLAG) AS METFORMIN_MEGL_REPA_FLAG
,MAX(METFORMIN_REPAGLINIDE_FLAG) AS METFORMIN_REPAGLINIDE_FLAG
,MAX(METFORMIN_SGLT2_CANA_FLAG) AS METFORMIN_SGLT2_CANA_FLAG
,MAX(METFORMIN_SGLT2_DAPA_FLAG) AS METFORMIN_SGLT2_DAPA_FLAG
,MAX(METFORMIN_SGLT2_EMPA_FLAG) AS METFORMIN_SGLT2_EMPA_FLAG
...
,MAX(TZD_PIOG_DPP4_ALOG_FLAG) AS TZD_PIOG_DPP4_ALOG_FLAG
...
(SELECT 
	...
	CASE WHEN MEDS_FLAG = 'DPP4_LINA_SGLT2_EMPA_FLAG' THEN 1 ELSE 0 END AS DPP4_LINA_SGLT2_EMPA_FLAG, 
	...
	CASE WHEN MEDS_FLAG = 'GLIM_TZD_PIOG_FLAG' THEN 1 ELSE 0 END AS GLIM_TZD_PIOG_FLAG, 
	CASE WHEN MEDS_FLAG = 'GLIM_TZD_ROSI_FLAG' THEN 1 ELSE 0 END AS GLIM_TZD_ROSI_FLAG, 
	...
	CASE WHEN MEDS_FLAG = 'METFORMIN_MEGL_REPA_FLAG' THEN 1 ELSE 0 END AS METFORMIN_MEGL_REPA_FLAG, 
	CASE WHEN MEDS_FLAG = 'METFORMIN_REPAGLINIDE_FLAG' THEN 1 ELSE 0 END AS METFORMIN_REPAGLINIDE_FLAG, 
	CASE WHEN MEDS_FLAG = 'METFORMIN_SGLT2_CANA_FLAG' THEN 1 ELSE 0 END AS METFORMIN_SGLT2_CANA_FLAG, 
	CASE WHEN MEDS_FLAG = 'METFORMIN_SGLT2_DAPA_FLAG' THEN 1 ELSE 0 END AS METFORMIN_SGLT2_DAPA_FLAG, 
	CASE WHEN MEDS_FLAG = 'METFORMIN_SGLT2_EMPA_FLAG' THEN 1 ELSE 0 END AS METFORMIN_SGLT2_EMPA_FLAG, 
	...
	CASE WHEN MEDS_FLAG = 'TZD_PIOG_DPP4_ALOG_FLAG' THEN 1 ELSE 0 END AS TZD_PIOG_DPP4_ALOG_FLAG, 
...
SELECT 
	...
	, 0 AS METFORMIN_MEGL_REPA_FLAG
	, 0 AS METFORMIN_REPAGLINIDE_FLAG
	, 0 AS METFORMIN_SGLT2_CANA_FLAG
	, 0 AS METFORMIN_SGLT2_DAPA_FLAG
	, 0 AS METFORMIN_SGLT2_EMPA_FLAG
...
WHERE (ENC.ENC_TYPE ='AV' )
	...
	AND MEDS_FLAG IN	
		(
			 ...
			 ,'METFORMIN_MEGL_REPA_FLAG'
			 ,'FIRST_GEN_SUL_FLAG'
			 ,'SAXAGLIPTIN_DAPAGLIFLOZIN_FLAG'
			 ,'SITAGLIPTIN_ERTUGLIFLOZIN_FLAG'
...
, CASE WHEN STUDY_ENTRY_YEAR =2017 THEN 1 ELSE 0 END as  COHORT_ENTRY_2017  /* added 2017*/
...
, SEX 
, CASE 
	WHEN AGE_ BETWEEN 18 and 29 THEN 'Age 18-29'
	WHEN AGE_ BETWEEN 30 and 39 THEN 'Age 30-39'
	WHEN AGE_ BETWEEN 40 and 49 THEN 'Age 40-49'
	WHEN AGE_ BETWEEN 50 and 59 THEN 'Age 50-59'
	WHEN AGE_ BETWEEN 60 and 69 THEN 'Age 60-69'
	WHEN AGE_ BETWEEN 70 and 79 THEN 'Age 70-79'
	WHEN AGE_ BETWEEN 80 and 89 THEN 'Age 80-89'
	WHEN AGE_ >=90 THEN 'Age 90+' END AS AGE_GROUP
from t1;
quit;	
